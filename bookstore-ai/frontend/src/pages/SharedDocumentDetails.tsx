...
export default function DocumentDetails() {
  ...
  // Badge pour afficher le rôle de l'utilisateur actuel
  const getUserPermissionBadge = () => {
    const userRole = getUserPermission();
    
    switch (userRole) {
      case 'owner': return <Badge bg="dark" className="ms-1">Propriétaire</Badge>;
      case 'admin': return <Badge bg="danger" className="ms-1">Administrateur</Badge>;
      case 'editor': return <Badge bg="warning" text="dark" className="ms-1">Éditeur</Badge>;
      case 'viewer': return <Badge bg="success" className="ms-1">Lecteur</Badge>;
      default: return null;
    }
  };
